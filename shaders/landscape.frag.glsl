...
void main() {
    ...
    // 3. Generate "mountains" and "beaches" based on elevation
     ...
     vec3 temperatureColor = vec3(0.3,0.1,0.1);
     ...
     float temperatureFactor = smoothstep(0.5, 0.4, temperature);
     landColor = mix(landColor, vec3(0.9, 0.9, 0.5), beachFactor);
    // landColor = mix(landColor, vec3(0.9, 0.9, 0.5), temperatureFactor);
